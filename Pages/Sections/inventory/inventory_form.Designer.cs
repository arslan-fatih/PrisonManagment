namespace PrisonManagment.Pages.Sections
{
    partial class inventory_form
    {
        ...
        private void InitializeComponent()
        {
            ...
            search_bar.PlaceholderText = "Search inventory...";
            // 
            // btnAddInventory
            // 
            btnAddInventory.BackColor = Color.FromArgb(45, 66, 91);
            btnAddInventory.Cursor = Cursors.Hand;
            btnAddInventory.FlatAppearance.BorderSize = 0;
            btnAddInventory.FlatAppearance.MouseOverBackColor = Color.FromArgb(72, 84, 96);
            btnAddInventory.FlatAppearance.MouseDownBackColor = Color.FromArgb(30, 39, 46);
            btnAddInventory.FlatStyle = FlatStyle.Flat;
            btnAddInventory.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            btnAddInventory.ForeColor = Color.White;
            btnAddInventory.Location = new Point(500, 20);
            btnAddInventory.Name = "btnAddInventory";
            btnAddInventory.Size = new Size(130, 35);
            ...
            // btnUpdateInventory
            // 
            btnUpdateInventory.BackColor = Color.FromArgb(45, 66, 91);
            btnUpdateInventory.Cursor = Cursors.Hand;
            btnUpdateInventory.FlatAppearance.BorderSize = 0;
            btnUpdateInventory.FlatAppearance.MouseOverBackColor = Color.FromArgb(72, 84, 96);
            btnUpdateInventory.FlatAppearance.MouseDownBackColor = Color.FromArgb(30, 39, 46);
            btnUpdateInventory.FlatStyle = FlatStyle.Flat;
            btnUpdateInventory.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            btnUpdateInventory.ForeColor = Color.White;
            btnUpdateInventory.Location = new Point(640, 20);
            btnUpdateInventory.Name = "btnUpdateInventory";
            btnUpdateInventory.Size = new Size(130, 35);
            ...
            // btnDeleteInventory
            // 
            btnDeleteInventory.BackColor = Color.FromArgb(214, 40, 40);
            btnDeleteInventory.Cursor = Cursors.Hand;
            btnDeleteInventory.FlatAppearance.BorderSize = 0;
            btnDeleteInventory.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 65, 65);
            btnDeleteInventory.FlatAppearance.MouseDownBackColor = Color.FromArgb(176, 30, 30);
            btnDeleteInventory.FlatStyle = FlatStyle.Flat;
            btnDeleteInventory.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            btnDeleteInventory.ForeColor = Color.White;
            btnDeleteInventory.Location = new Point(780, 20);
            btnDeleteInventory.Name = "btnDeleteInventory";
            btnDeleteInventory.Size = new Size(130, 35);
            btnDeleteInventory.TabIndex = 12;
            btnDeleteInventory.Text = "Delete";
            btnDeleteInventory.UseVisualStyleBackColor = false;
